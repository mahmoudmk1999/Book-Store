            ...
            <div class="card-body">
                ...
                <form action="{{route('books.update', $book)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="title" name="title" value="{{$book->title}}"  autocomplete="title" type="text" class="form-control @error('title') is-invalid @enderror">
                            @error('title')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="isbn" name="isbn" value="{{$book->isbn}}"  autocomplete="isbn" type="text" class="form-control @error('isbn') is-invalid @enderror">
                            @error('isbn')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="category" name="category" class="form-control">
                                <option disabled {{$book->category == null ? "selected" : ""}}>Select Category</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select id="publisher" name="publisher" class="form-control">
                                <option disabled {{$book->publisher == null ? 'selceted' : ""}}>Select Publisher</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea id="description" name="description" autocomplete="description" type="text" class="form-control @error('description') is-invalid @enderror">{{$book->description}}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="publish_year" name="publish_year" value="{{$book->publish_year}}"  autocomplete="publish_year" type="number" class="form-control @error('publish_year') is-invalid @enderror">
                            @error('publish_year')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="number_of_pages" name="number_of_pages" value="{{$book->number_of_pages}}"  autocomplete="number_of_pages" type="number" class="form-control @error('number_of_pages') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="number_of_copies" name="number_of_copies" value="{{$book->number_of_copies}}"  autocomplete="number_of_copies" type="number" class="form-control @error('number_of_copies') is-invalid @enderror">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="price" name="price" value="{{$book->price}}"  autocomplete="price" type="number" class="form-control @error('price') is-invalid @enderror">
                            @error('price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{$message}}</strong>
                            </span>
