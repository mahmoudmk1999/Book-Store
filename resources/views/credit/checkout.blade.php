...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div id="success" style="display:none" class="col-md-8 text-center h3 p-4 bg-success text-light rounded">Purchases Has Been Successfully</div>
            <div class="col-md-8">
                <div class="card">
    ...
    <script>
        ...
        $('.card-form').on('submit', function (e) {
            ...
            stripe.confirmCardSetup(
                ...
                if (result.error) {
                    toastr.error('The data Is not True Make Sure')
