...
@section('content')
    <div class="container">
        <a href="{{route('gallery.index')}}" class="btn btn-primary mb-5"><i class="fa fa-plus"></i> By New Book</a>
                    ...
                    @foreach($myBooks as $book)
                        <div class="row p-2 bg-white border rounded">
                            ...
                            <div class="col-md-6 my-auto">
                                <h5><a href="{{route('book.details',$book)}}" class="text-secondary" style="text-decoration: none" >{{$book->title}}</a></h5>
                                ...
                                <div class="mt-1 mb-1 spec-1"><span>Date Of Perches : {{$book->pivot->created_at->diffForHumans()}}<br></span></div>
                            ...
                            <div class="align-items-center align-content-center col-md-3 border-left my-auto">
                                ...
                                <div class="d-flex flex-column mt-4"><a href="{{route('book.details',$book)}}" class="btn btn-outline-primary btn-sm" type="button">Book Details</a></div>
                            </div>
                        </div>
                    @endforeach
                @else
                    <div class="alert alert-danger mx-auto" role="alert">
                        There Is No Purchases At Now
                    </div>
                @endif
        </div>
    </div>
