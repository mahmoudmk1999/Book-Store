...
class AuthorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('flash_message', 'Author Has Been Added Successfully');
    ...
    public function update(Request $request, Author $author)
    {
        ...
        session()->flash('flash_message', 'Author Has Been Edited Successfully');
    ...
    public function result(Author $author){
        ...
        $title = 'Books Have Same Author : ' . $author->name;
